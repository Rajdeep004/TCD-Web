...
const Testimonials = () => {
    ...
    const testimonials = [
        ...
        },
        {
            ...
            quote: "My company's software now is easy to use, saves time and money, and is loved by a lot of users. One customer saved $10k over the course of 3 years and another saves 8 hours per week! Thanks to TCD."
        },
        {
        ...
        <SectionWrapper className="pb-0">
            <div id="testimonials" className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-2xl sm:text-center md:mx-auto">
                    <h2 className="text-accent text-3xl font-semibold sm:text-4xl">
                                ...
                                <li key={idx} className=" border p-4 rounded-xl">
                                    <figure>
                                        <div className="flex items-center gap-x-4">
                                            ...
                                            <div>
                                                <span className="block text-primary font-semibold">{item.name}</span>
